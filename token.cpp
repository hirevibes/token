...
void token::claim( account_name owner, symbol_type sym ) {
  eosio_assert(false, "claim action is disabled!");
...
void token::payram( account_name owner, symbol_type sym, account_name payer ) {
  do_claim(owner, sym, payer);
...
EOSIO_ABI( eosio::token, (create)(update)(issue)(transfer)(claim)(recover)(payram))
